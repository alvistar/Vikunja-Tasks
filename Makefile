...
gen:
	@printf '// Generated by `make gen` from the VERSION file. Do not edit.\nVEYRN_MARKETING_VERSION = %s\n' "$$(tr -d '[:space:]' < VERSION)" > Version.xcconfig
	@echo "✓ Version.xcconfig ← VERSION ($$(tr -d '[:space:]' < VERSION))"
	xcodegen generate
